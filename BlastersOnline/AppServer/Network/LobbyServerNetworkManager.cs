...
namespace AppServer.Network
{
    ...
    /// </summary>
    public class LobbyServerNetworkManager
    {
        private static LobbyServerNetworkManager _instance;
        ...
        public static LobbyServerNetworkManager Instance
        {
            get { return _instance ?? (_instance = new LobbyServerNetworkManager()); }
        }

        private readonly NetClient _client;

        public LobbyServerNetworkManager()
        {
        ...
        {
            _client.Disconnect("Logging out...");
