namespace BlastersLobby
{
    partial class FormWebView
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.timerPacketPoller = new System.Windows.Forms.Timer(this.components);
            this.SuspendLayout();
            // 
            // webControl1
            // 
            ...
            // timerPacketPoller
            // 
            this.timerPacketPoller.Enabled = true;
            this.timerPacketPoller.Interval = 10;
            this.timerPacketPoller.Tick += new System.EventHandler(this.timerPacketPoller_Tick);
            // 
            // FormWebView
            // 
            ...
            this.Text = "Blasters Online";
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FormWebView_FormClosed);
        ...
        private System.Windows.Forms.Timer timerPacketPoller;
    }
}