...
namespace PuzzleGame.Screens
{
    public class LevelScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            ChangeLevel(1);
            _textureAtlas = ScreenManager.Game.Content.Load<Texture2D>(@"Levels\BMOTiles");
        ...
        public override void Draw(Microsoft.Xna.Framework.GameTime gameTime)
        {
            ...
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.NonPremultiplied, null, null, null, null, _camera.GetTransformation());
